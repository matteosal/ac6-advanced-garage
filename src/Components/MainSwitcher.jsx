...
const HelpModal = ({closeModal}) => {
	return(
		...
		<p style={{paddingBottom: '15px'}}>
			Insert a build link generated by the CREATE BUILD LINK button of the build section in
			any of the input fields and click LOAD or press enter to load the build in the panel.
			Tick two of the COMPARE checkboxes at the bottom and click the SHOW SPECS button to
			compare the builds.
		</p>
		<ul style={{paddingLeft: '20px', paddingBottom: '10px'}}>
		...
		<p style={{paddingBottom: '15px'}}>
			Contains tables to inspect the specs for all the parts in the game. Clicking on
			...
			to other columns. Unit parts can also be filtered according to their attributes.
		</p>
		<button
